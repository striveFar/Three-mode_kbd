...
#define dprint(s)                   do { if (debug_enable) log_print(s); } while (0)
#define dprintln(s)                 do { if (debug_enable) log_info(s); } while (0)
#define dprintf(...)                do { if (debug_enable) log_info(__VA_ARGS__); } while (0)
